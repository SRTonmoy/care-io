                ...
                <form onSubmit={handleProfileSubmit} className="space-y-6">
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      disabled={saving}
                      className="flex items-center justify-center space-x-2 w-full bg-gradient-to-r from-green-600 to-teal-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-green-700 hover:to-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                      {saving ? (
                        <>
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-6">
                  ...
                  <div className="pt-4 flex space-x-3">
                    <button
                      type="submit"
                      disabled={saving}
                      className="flex-1 flex items-center justify-center space-x-2 bg-gradient-to-r from-green-600 to-teal-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-green-700 hover:to-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                      {saving ? (
                        <>
                          <LoadingSpinner size="small" />
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {getVerificationBadge(userData.phoneVerified)}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {getVerificationBadge(userData.nidVerified)}
                        </p>
                      </div>
                    </div>
                  </div>
